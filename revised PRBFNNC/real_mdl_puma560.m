...
L(1) = Revolute('d', 0, ...   % link length (Dennavit-Hartenberg notation)
    ...
    'I', [0, 0.35+0.35*0.2, 0, 0, 0, 0], ... % inertia tensor of link with respect to center of mass I = [L_xx, L_yy, L_zz, L_xy, L_yz, L_xz]
    'r', [0, 0, 0], ...       % distance of ith origin to center of mass [x,y,z] in link reference frame
    'm', 0+0*0.3, ...               % mass of link
...
L(2) = Revolute('d', 0, 'a', 0.4318, 'alpha', 0, ...
    'I', [0.13+0.13*0.2, 0.524+0.524*0.2, 0.539+0.539*0.2, 0, 0, 0], ...
    'r', [-0.3638*1.3, 0.006*1.3, 0.2275*1.3], ...
    'm', 17.4+17.4*0.3, ...
    'Jm', 200e-6, ...
    'G', 107.815, ...
    'B', .817e-3, ...
...
L(3) = Revolute('d', 0.15005, 'a', 0.0203, 'alpha', -pi/2,  ...
    'I', [0.066*1.2, 0.086*1.2, 0.0125*1.2, 0, 0, 0], ...
    'r', [-0.0203*1.3, -0.0141*1.3, 0.070], ...
    'm', 4.8+4.8*0.3, ...
    'Jm', 200e-6, ...
    'G', -53.7063, ...
    'B', 1.38e-3, ...
